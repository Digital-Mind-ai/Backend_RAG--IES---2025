...
"""
    ...
    def run_agent(self, conversation_id: str, thread_id: str, user_input: str, attachments: list = None) -> Dict[str, Any]:
        """Ejecuta el agente RAG para un mensaje de usuario específico."""
        
        user_message_id = self._log_message(conversation_id, "user", user_input, attachments)
        final_text = ""
